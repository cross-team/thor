...
The assests directory contains the orderList.json file that populates the KanBanCards into the KanBanBoard. It contains all of the endpoints that would be relevant to the KanBanCard component.
